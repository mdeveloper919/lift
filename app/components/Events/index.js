...
const exampleFakeEvents = fromJS([
  {
    image: 'http://www.marijuana.com/wp-content/uploads/2016/06/header-2-702x336.jpeg',
  ...
  <div className="row column">
    <div className="news">
      <div className="row align-middle mb-lg">
        ...
        <div className="shrink column"><Link to="#">see all</Link></div>
      </div>
      <div className="row">
        {data.map((item) => {
