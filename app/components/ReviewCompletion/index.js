      ...
      <div className="reviewCompletion__progress">
        <div className="text-center c-white">
          <CircleProgressBar
            ...
            radius={75}
          />
          <div className="reviewCompletion__shortDesc mt-md"><strong>200</strong> average</div>
          <div className="reviewCompletion__shortDesc"><strong>500</strong> high quality</div>
        </div>
      </div>
