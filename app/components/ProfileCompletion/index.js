...
const ProfileCompletion = ({ user }: Props) => {
  ...
  return (
    <div className="profileCompletion">
      <div className="profileCompletion__header">
        Profile Completion
      </div>
      ...
      <div className="profileCompletion__info">
        <h4 className="profileCompletion__description">
          Just getting started? Complete your public profile and receive
          50 points for the <Link to="/me/rewards">Lift Shop</Link>.
        </h4>
