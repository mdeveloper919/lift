...
const CartItem = ({ lineItem, increaseQuantity, decreaseQuantity }: Props) => (
  ...
  >
    ...
    <div className="small-9 column">
      <div className="cartItem__title mb-mn">
        {lineItem.title}
      </div>
      {
        lineItem.variant_title !== 'Default Title' && <div className="cartItem__varitantTitle mb-mn">
      ...
      <div className="row align-middle mb-md fs-tn">
        ...
        <div className="cartItem__quantityValue shrink column">{lineItem.quantity}</div>
        <button
          className="cartItem__quantityChange shrink column"
