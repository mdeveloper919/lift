...
const MemberProfile = ({ data, reviewsCount, helpfulReviewsCount }: Props) => {
  ...
  return (
    <div className="memberProfile row mb-hg">
      ...
      <div className="memberProfile__details column">
        ...
        <div className="row align-bottom mb-lg">
          {fullName && <div className="shrink column">
            <h4 className="nm">{fullName}</h4>
          </div>}
          <div className="column">
            <TimeAgo
              data={user.get('lastonline')}
              title="Last online"
            />
          </div>
        </div>
        <div className="memberProfile__merit row">
          <div className="memberProfile__meritItem column">
            <Icon
              className="mr-md"
          ...
          {reviewsCount !== null && <div className="memberProfile__meritItem column">
            <Icon
              className="mr-md"
              glyph={IconReview}
              size={40}
          ...
          {helpfulReviewsCount !== null && <div className="memberProfile__meritItem column">
            <Icon
              className="mr-md"
              glyph={IconReward}
              size={40}
            />
            <strong>{helpfulReviewsCount}</strong>&nbsp;helpful reviews
          </div>}
        </div>
        <div className="memberProfile__personal">
          <div className="row">
            {fullLocation && <div className="shrink column">
              From <strong>{fullLocation}</strong>
            </div>}
            <div className="shrink column">
            Member since <strong>{joinDate}</strong>
            </div>
            {usingCannabisSince && <div className="shrink column">
